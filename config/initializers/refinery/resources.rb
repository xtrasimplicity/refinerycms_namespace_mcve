...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret          = "888e895bb61793846a19f181e531092fa3a0db21ade208be"
  # config.dragonfly_url_host        = ""
  # config.dragonfly_datastore_root_path = "/tmp/refinerycms-extension-namespace-mcve/public/system/refinery/resources"
